...
CLASSES = {
    "scholar": {
        ...
        "skills": [
            # ── OFFENSIVE ──
            {"name": "Eldritch Blast", "icon": "*", "unlock_lv": 1, "desc": "Hurl a bolt of pure eldritch energy.", "formula": "dmg = (5 + INTx1.5) x 1.8", "type": "magic", "power": 1.8, "stat": "int", "cost": 0, "cd": 0, "tags": ["offensive"], "tier": 1, "category": "offensive", "stat_priority": ["int"], "starting": True},
            {"name": "Arcane Missile", "icon": "~", "unlock_lv": 1, "desc": "Fast homing missiles of condensed thought.", "formula": "dmg = (5 + INTx1.5) x 1.2, cannot miss", "type": "magic", "power": 1.2, "stat": "int", "cost": 5, "cd": 0, "true_strike": True, "tags": ["offensive"], "tier": 1, "category": "offensive", "stat_priority": ["int"], "starting": True},
            ...
            {"name": "Cartographer's Eye", "icon": "c", "unlock_lv": 4, "desc": "Read the dungeon's secrets. +25% CRIT, +20% EVA 3 turns.", "formula": "Self: CRIT+25%, EVA+20% for 3 turns", "type": "self_buff", "cost": 8, "cd": 5, "buff_type": "critUp", "buff_duration": 3, "tags": ["utility"], "tier": 2, "category": "utility", "stat_priority": ["wis", "luck"]},
            {"name": "Forbidden Text Deciphered", "icon": "f", "unlock_lv": 14, "desc": "Decipher eldritch glyphs. INT+6, WIS+4 for 5 turns.", "formula": "Self: INT+6, WIS+4 for 5 turns (combat only)", "type": "self_buff", "cost": 0, "cd": 8, "buff_type": "permIntWis", "buff_duration": 5, "tags": ["utility"], "tier": 3, "category": "utility", "stat_priority": ["int", "wis"]},
            {"name": "Liminal Step", "icon": "l", "unlock_lv": 12, "desc": "Phase between dimensions. EVA+50%, mDEF+40% 3 turns.", "formula": "Self: EVA+50%, mDEF+40% for 3 turns", "type": "self_buff", "cost": 10, "cd": 6, "buff_type": "dreamVeil", "buff_duration": 3, "tags": ["utility"], "tier": 3, "category": "utility", "stat_priority": ["agi", "wis"]},
    ...
    "brute": {
        ...
        "skills": [
            # ── OFFENSIVE ──
            {"name": "Crushing Blow", "icon": "*", "unlock_lv": 1, "desc": "A devastating overhead strike.", "formula": "dmg = ATKx1.6 + STRx0.8 physical", "type": "physical", "power": 1.6, "stat": "str", "cost": 0, "cd": 0, "tags": ["offensive"], "tier": 1, "category": "offensive", "stat_priority": ["str"], "starting": True},
            {"name": "Quick Slash", "icon": "~", "unlock_lv": 1, "desc": "A fast, agile cut.", "formula": "dmg = ATKx1.2 + AGIx0.6, fast recovery", "type": "physical", "power": 1.2, "stat": "agi", "cost": 0, "cd": 0, "tags": ["offensive"], "tier": 1, "category": "offensive", "stat_priority": ["agi"], "starting": True},
            ...
            {"name": "Warpaint", "icon": "w", "unlock_lv": 4, "desc": "Apply warpaint. STR+5 for 5 turns.", "formula": "Self: STR+5 for 5 turns (combat only)", "type": "self_buff", "cost": 0, "cd": 6, "buff_type": "permAtk2", "buff_duration": 5, "tags": ["utility"], "tier": 2, "category": "utility", "stat_priority": ["str"]},
            {"name": "Blood Scent", "icon": "S", "unlock_lv": 4, "desc": "Smell their fear. ATK+20%, CRIT+15% 3 turns.", "formula": "Self: ATK+20%, CRIT+15% for 3 turns", "type": "self_buff", "cost": 5, "cd": 5, "buff_type": "atkCritUp", "buff_duration": 3, "tags": ["utility"], "tier": 2, "category": "utility", "stat_priority": ["luck"]},
            ...
            {"name": "Collector's Eye", "icon": "e", "unlock_lv": 2, "desc": "Spot weaknesses. +20% CRIT for 3 turns.", "formula": "Self: CRIT+20% for 3 turns", "type": "self_buff", "cost": 5, "cd": 4, "buff_type": "critUp", "buff_duration": 3, "tags": ["utility"], "tier": 1, "category": "utility", "stat_priority": ["luck"]},
            {"name": "Thick Skull", "icon": "k", "unlock_lv": 10, "desc": "Hardened mind and body. STR+4, WIS+3 for 5 turns.", "formula": "Self: STR+4, WIS+3 for 5 turns (combat only)", "type": "self_buff", "cost": 0, "cd": 7, "buff_type": "thickSkull", "buff_duration": 5, "tags": ["utility"], "tier": 2, "category": "utility", "stat_priority": ["str", "wis"]},
        ],
    },
    ...
    "warden": {
        ...
        "skills": [
            # ── OFFENSIVE ──
            {"name": "Holy Strike", "icon": "~", "unlock_lv": 1, "desc": "Channel divine wrath into a smite.", "formula": "dmg = (5 + WISx1.3) x 1.4 eldritch", "type": "magic", "power": 1.4, "stat": "wis", "cost": 0, "cd": 0, "tags": ["offensive"], "tier": 1, "category": "offensive", "stat_priority": ["wis"], "starting": True},
            {"name": "Shield Bash", "icon": "#", "unlock_lv": 2, "desc": "Strike with your shield. Scales with DEF.", "formula": "dmg = DEFx2.0 + WISx0.5, physical", "type": "physical", "power": 2.0, "stat": "wis", "def_scaling": True, "cost": 5, "cd": 2, "tags": ["offensive", "dual-stat"], "tier": 1, "category": "offensive", "stat_priority": ["wis", "str"], "starting": True},
            ...
            # ── UTILITY ──
            {"name": "Threshold Sense", "icon": "q", "unlock_lv": 1, "desc": "Sense the beyond. WIS+3 for 4 turns.", "formula": "Self: WIS+3 for 4 turns", "type": "self_buff", "cost": 0, "cd": 4, "buff_type": "innerFire", "buff_duration": 4, "tags": ["utility"], "tier": 1, "category": "utility", "stat_priority": ["wis", "luck"]},
            ...
            {"name": "Oath of the Warden", "icon": "O", "unlock_lv": 16, "desc": "Swear an oath. WIS+6, STR+4 for 5 turns.", "formula": "Self: WIS+6, STR+4 for 5 turns (combat only)", "type": "self_buff", "cost": 0, "cd": 8, "buff_type": "permWisStr", "buff_duration": 5, "tags": ["utility"], "tier": 3, "category": "utility", "stat_priority": ["wis", "str"]},
            ...
            {"name": "Warden's Insight", "icon": "W", "unlock_lv": 4, "desc": "Read enemy intent. pDEF+30%, mDEF+30% 3 turns.", "formula": "Self: pDEF+30%, mDEF+30% for 3 turns", "type": "self_buff", "cost": 5, "cd": 5, "buff_type": "thoughtform", "buff_duration": 3, "tags": ["utility"], "tier": 1, "category": "utility", "stat_priority": ["wis", "luck"]},
            {"name": "Perseverance", "icon": "Q", "unlock_lv": 12, "desc": "Stand firm. WIS+4, STR+3 for 5 turns.", "formula": "Self: WIS+4, STR+3 for 5 turns (combat only)", "type": "self_buff", "cost": 0, "cd": 7, "buff_type": "perseverance", "buff_duration": 5, "tags": ["utility"], "tier": 3, "category": "utility", "stat_priority": ["wis", "str"]},
        ],
    },
    ...
    "shadowblade": {
        ...
        "skills": [
            # ── OFFENSIVE ──
            {"name": "Shadow Strike", "icon": "*", "unlock_lv": 1, "desc": "A swift strike from the shadows.", "formula": "dmg = ATKx1.5 + AGIx1.0 physical", "type": "physical", "power": 1.5, "stat": "agi", "cost": 0, "cd": 0, "tags": ["offensive"], "tier": 1, "category": "offensive", "stat_priority": ["agi"], "starting": True},
            {"name": "Backstab", "icon": "#", "unlock_lv": 2, "desc": "Strike from behind. +50% crit chance.", "formula": "dmg = ATKx1.8 + AGIx0.5, +50% CRIT", "type": "physical", "power": 1.8, "stat": "agi", "flat_crit_bonus": 50, "cost": 8, "cd": 2, "tags": ["offensive"], "tier": 1, "category": "offensive", "stat_priority": ["agi"], "starting": True},
            ...
            # ── UTILITY ──
            {"name": "Sixth Sense", "icon": "6", "unlock_lv": 1, "desc": "Sharpen your senses. CRIT+25% for 4 turns.", "formula": "Self: CRIT+25% for 4 turns (combat only)", "type": "self_buff", "cost": 0, "cd": 5, "buff_type": "permCrit10", "buff_duration": 4, "tags": ["utility"], "tier": 1, "category": "utility", "stat_priority": ["agi", "luck"]},
            ...
            {"name": "Perfect Assassin", "icon": "P", "unlock_lv": 16, "desc": "Become one with the blade. AGI+7, LUCK+4 for 5 turns.", "formula": "Self: AGI+7, LUCK+4 for 5 turns (combat only)", "type": "self_buff", "cost": 0, "cd": 8, "buff_type": "permAgiLuk", "buff_duration": 5, "tags": ["utility"], "tier": 3, "category": "utility", "stat_priority": ["agi", "luck"]},
            ...
            {"name": "Shadow's Blessing", "icon": "b", "unlock_lv": 10, "desc": "Embrace the shadows. AGI+4, LUCK+3 for 5 turns.", "formula": "Self: AGI+4, LUCK+3 for 5 turns (combat only)", "type": "self_buff", "cost": 0, "cd": 7, "buff_type": "shadowBless", "buff_duration": 5, "tags": ["utility"], "tier": 2, "category": "utility", "stat_priority": ["agi", "luck"]},
        ],
    },
    ...
    "mad_prophet": {
        ...
        "skills": [
            # ── OFFENSIVE ──
            {"name": "Prophetic Vision", "icon": "*", "unlock_lv": 1, "desc": "A flash of terrible insight, weaponized.", "formula": "dmg = (5 + WISx1.5) x 1.3 magic", "type": "magic", "power": 1.3, "stat": "wis", "cost": 0, "cd": 0, "tags": ["offensive"], "tier": 1, "category": "offensive", "stat_priority": ["wis"], "starting": True},
            {"name": "Channel Madness", "icon": "#", "unlock_lv": 2, "desc": "Convert madness into power.", "formula": "dmg = WISx2.0 x (1 + MAD/100), costs 5 MAD", "type": "magic", "power": 1.0, "stat": "wis", "madness_scaling": True, "madness_cost": 5, "cost": 0, "cd": 2, "tags": ["offensive"], "tier": 1, "category": "offensive", "stat_priority": ["wis"], "starting": True},
            ...
            {"name": "Fate Reading", "icon": "r", "unlock_lv": 1, "desc": "Read the enemy's fate. +20% CRIT, +15% EVA 3 turns.", "formula": "Self: CRIT+20%, EVA+15% for 3 turns", "type": "self_buff", "cost": 0, "cd": 4, "buff_type": "critUp", "buff_duration": 3, "tags": ["utility"], "tier": 1, "category": "utility", "stat_priority": ["wis", "luck"]},
            ...
            {"name": "Lucky Coin Toss", "icon": "t", "unlock_lv": 4, "desc": "Flip for fortune. LUCK+5 for 4 turns.", "formula": "Self: LUCK+5 for 4 turns", "type": "self_buff", "cost": 5, "cd": 4, "buff_type": "innerFire", "buff_duration": 4, "tags": ["utility"], "tier": 2, "category": "utility", "stat_priority": ["luck"]},
            ...
            {"name": "Vision of the End", "icon": "V", "unlock_lv": 14, "desc": "See the apocalypse. All stats +4 for 5 turns.", "formula": "Self: all stats +4 for 5 turns (combat only)", "type": "self_buff", "cost": 0, "cd": 8, "buff_type": "permAll1", "buff_duration": 5, "tags": ["utility"], "tier": 3, "category": "utility", "stat_priority": ["wis"]},
            ...
            {"name": "Unreliable Fortune", "icon": "u", "unlock_lv": 2, "desc": "Unpredictable luck. LUCK+3, EVA+15% 3 turns.", "formula": "Self: LUCK+3, EVA+15% for 3 turns", "type": "self_buff", "cost": 0, "cd": 4, "buff_type": "luckyDodge", "buff_duration": 3, "tags": ["utility"], "tier": 1, "category": "utility", "stat_priority": ["luck"]},
        ],
    },
}
