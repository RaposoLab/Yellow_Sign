...
from data.constants import (
    ...
    HEAL_TITAN_RESIL_FRAC,
    HEAL_DEVOUR_FRAC,
    HEAL_MEDITATION_FRAC,
    HEAL_DARK_REGEN_FRAC,
    HEAL_SECOND_WIND_FRAC,
    HEAL_NIMBLE_RECOV_FRAC,
    MADNESS_COST_HEAVY,
    MADNESS_COST_MAJOR,
    MADNESS_COST_MEDIUM,
    MADNESS_COST_STANDARD,
    MADNESS_COST_LIGHT,
    MADNESS_COST_MINOR,
    MADNESS_COST_TINY,
    BUFF_RAGE_HP_PCT,
    BUFF_WARLORD_HP_PCT,
    BUFF_STAT_BOOST_TINY,
    BUFF_STAT_BOOST_MINOR,
    BUFF_STAT_BOOST_SMALL,
    BUFF_STAT_BOOST_MEDIUM,
    BUFF_STAT_BOOST_LARGE,
